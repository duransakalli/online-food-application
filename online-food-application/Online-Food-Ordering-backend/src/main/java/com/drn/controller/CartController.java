...
import com.drn.request.UpdateCartItemRequest;
import com.drn.service.CartService;
...
public class CartController {
    ...
    @PutMapping("/cart/add")
    public ResponseEntity<CartItem> addItemToCard(@RequestBody AddCartItemRequest request,
